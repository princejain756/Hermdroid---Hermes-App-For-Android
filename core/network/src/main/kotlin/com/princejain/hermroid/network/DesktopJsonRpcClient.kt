...
class DesktopJsonRpcClient(private val address:ServerAddress){
    ...
    private val mutableEvents=MutableSharedFlow<DesktopEvent>(extraBufferCapacity=128); val events=mutableEvents.asSharedFlow(); private var socket:WebSocket?=null; private var ready=CompletableDeferred<Unit>()
